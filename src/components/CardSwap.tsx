...
const CardSwap: React.FC<CardSwapProps> = ({
  ...
  // Track the order of cards from front to back for state management
  ...
  // Notify parent when card order changes
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    const swap = () => {
      ...
      // Update React state immediately for content sync
  ...
  }, [cardDistance, verticalDistance, delay, pauseOnHover, skewAmount, easing, onCardOrderChange]);
