...
const LayeredPreview: React.FC = () => {
  // Sidebar fades in; its inner items stagger in from left after sidebar is visible
  const [sidebarRef, sidebarInView] = useInViewOnce<HTMLDivElement>({
    threshold: 0.15,
    rootMargin: "0px 0px -10% 0px",
  });

  // Main content (header and cards) animate in after entering view
  const [mainRef, mainInView] = useInViewOnce<HTMLDivElement>({
    threshold: 0.15,
    rootMargin: "0px 0px -10% 0px",
  });
  ...
  return (
    <div className="relative w-full h-full pointer-events-none select-none">
      ...
      <div className="absolute inset-0 w-full h-full" style={{ zIndex: 10 }}>
        <div
          className={`absolute reveal ${sidebarInView ? "is-inview" : ""}`}
          ref={sidebarRef}
        ...
        >
          ...
          <div
            className={`absolute left-[8%] right-[8%] stagger ${
              sidebarInView ? "is-inview" : ""
            }`}
          ...
          >
            <div className="flex flex-col gap-0">
              <img
                ...
                className="block w-full h-auto stagger-item"
              />
              <img
      ...
      <div className="absolute inset-0 w-full h-full" style={{ zIndex: 15 }}>
        ...
        >
          ...
          <img
            ...
            alt="Header"
            className={`block w-full h-auto reveal reveal-fade-up ${
              mainInView ? "is-inview" : ""
            }`}
          />
          ...
          <div className="ml-[5px] mt-[5px]">
            <div
              className={`grid grid-cols-3 gap-[5px] stagger ${mainInView ? "is-inview" : ""}`}
              style={{ zIndex: 30 }}
            >
