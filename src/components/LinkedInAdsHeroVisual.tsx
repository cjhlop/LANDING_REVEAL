    ...
    <div className="relative w-full bg-slate-50/50 rounded-3xl overflow-hidden border border-slate-200 p-4 md:p-6">
          ...
          <table className="w-full text-[10px]">
            <thead>
              <tr className="bg-blue-50/50 text-slate-500 border-b border-slate-100">
                ...
                <th className="p-2 text-left font-semibold">Remaining Budget</th>
                <th className="p-2 text-left font-semibold">Forecasted Spend</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-slate-50">
              <tr className="font-bold text-slate-900">
                <td className="p-2">Budget Group</td>
                <td className="p-2">$11,591 <span className="text-emerald-500">(58%)</span></td>
                <td className="p-2">$8,408 <span className="text-emerald-500">(42%)</span></td>
                <td className="p-2">$11,591 <span className="text-emerald-500">(58%)</span></td>
              </tr>
              <tr className="text-slate-600">
                <td className="p-2">Cold Layer Ads</td>
                <td className="p-2">$2,178</td>
                <td className="p-2">$-2,178</td>
                <td className="p-2">$2,178</td>
              </tr>
            </tbody>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-3">
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-medium text-slate-700">Impressions Cap</span>
            </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-3">
        <div className="flex items-center justify-between mb-2">
          <h4 className="text-[10px] font-bold text-slate-800">Spend by Hour</h4>
          <MoreVertical className="w-3 h-3 text-slate-400" />
        </div>
        <div className="h-16 w-full flex items-end gap-0.5">
          {[...Array(48)].map((_, i) => {
