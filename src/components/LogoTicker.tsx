...
import { Hexagon, Triangle, CircleDashed, Component, FileSearch, ArrowRight } from "lucide-react";
    ...
    >
      ...
      >
        ...
        <p className="text-center text-[18px] md:text-[20px] font-semibold text-white/90 leading-snug max-w-2xl">
          Hundreds of B2B marketers trust DemandSense to grow{" "}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-8">
          ...
          >
            <FileSearch className="w-[26px] h-[26px] text-white/80" strokeWidth={1.75} />
