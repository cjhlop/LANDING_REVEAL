...
import { Hexagon, Triangle, CircleDashed, Component, TrendingUp, ArrowRight } from "lucide-react";
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-8">
          ...
          >
            <TrendingUp className="w-[26px] h-[26px] text-white/80" strokeWidth={1.75} />
