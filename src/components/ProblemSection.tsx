      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
        ...
        <div class="problem-animate trend-block p-6 sm:p-8 lg:p-10" style="animation-delay: 300ms;">
          ...
          <div class="trend-icon-wrapper">
            ...
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#3875F6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/></svg>
          </div>
