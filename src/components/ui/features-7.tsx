...
export const Features = () => {
  ...
  return (
    <section className="bg-gray-50 relative overflow-hidden" style={{ height: '900px' }}>
      ...
      {/* Right: Cards with reduced spacing for more overlap */}
      <CardSwap
        width={918}
        height={517}
        cardDistance={58}
      ...
      >
        ...
        {/* Card 3 - "Audience Tuning Exclusion" */}
        <Card className="bg-white text-black overflow-hidden shadow-lg flex flex-col">
          <BrowserHeader title="Audience Tuning Exclusion" />
          <div className="flex-1 bg-gray-100 flex items-center justify-center">
            <img
              src="/media/audience-tuning-exclusion.webp"
              alt="Audience Tuning Exclusion - product preview"
              className="max-w-full max-h-full object-contain"
              loading="lazy"
            />
          </div>
