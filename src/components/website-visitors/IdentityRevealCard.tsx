...
const IdentityRevealCard = ({ active }: { active: boolean }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-xl shadow-xl p-5 w-72 transform transition-all duration-500 text-white">
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-center gap-3">
          {/* Avatar */}
          <div className={cn(
            "w-10 h-10 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center text-white font-bold text-lg transition-all duration-500",
          ...
          <div>
            ...
            <div className="h-6 flex items-center">
              <span className="font-bold text-white text-lg leading-none">
                {typedName}
                {stage === 2 && <span className="animate-pulse text-blue-300">|</span>}
              </span>
            </div>
            {/* Job Title */}
            <div className={cn(
              "text-xs text-blue-100 font-medium transition-all duration-500",
      ...
      <div className="space-y-2 text-sm text-blue-50">
        <div className={cn(
          "flex items-center gap-2 transition-all duration-500 delay-0",
        ...
        <div className={cn(
          "flex items-center gap-2 transition-all duration-500 delay-100",
          stage >= 4 ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
        )}>
          <span className="w-1.5 h-1.5 rounded-full bg-green-400" />
