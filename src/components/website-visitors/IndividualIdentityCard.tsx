...
const IndividualIdentityCard = () => {
  ...
  return (
    ...
    >
      ...
      {/* Animated Card Container - Positioned to peek from bottom right */}
      <div className={cn(
        "absolute right-8 bottom-6 md:right-12 md:bottom-8 transition-all duration-500 ease-out z-20",
