...
type AnalyzerState = "hero" | "loading" | "industry-brief" | "gate" | "competitor-deep-dive" | "final-cta";
      ...
      <main>
        ...
        <section className="relative pt-12 pb-32 px-6 overflow-hidden">
          <div className="max-w-[1216px] mx-auto">
            ...
            {state === "loading" && (
              <div className="max-w-md mx-auto text-center py-20 space-y-6 animate-in fade-in zoom-in-95 duration-500">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-gray-500">Identifying industry and scanning LinkedIn ad landscape.</p>
                </div>
              </div>
            )}
          </div>
            ...
            <div className="max-w-[1216px] mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-gray-600 leading-relaxed">Unlock detailed breakdowns of specific competitors' ad strategies to see exactly how they win.</p>
                </div>
              </div>
            </div>
          </section>
