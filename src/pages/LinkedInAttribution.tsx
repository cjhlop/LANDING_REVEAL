    ...
    <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
              ...
              <div className="lg:col-span-5 space-y-8">
                ...
                <div className="p-8 bg-white rounded-2xl border border-slate-200 shadow-sm relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-blue-500/5 animate-pulse-bg pointer-events-none" />
                  ...
                  <div className="flex flex-col gap-8 relative z-10">
                    ...
                    <div className="flex items-center justify-between gap-2 relative">
                      ...
                      <div className="flex flex-col items-center gap-2 flex-1">
                        <div className="w-full h-12 rounded-lg border border-slate-100 bg-slate-50 flex items-center justify-center text-[11px] font-bold text-slate-500 transition-all duration-300 animate-active-node-1 relative overflow-hidden">
                          <div className="absolute inset-0 bg-blue-400/40 blur-xl opacity-0 animate-shining-light-1" />
                          LinkedIn Ads
                        </div>
                      </div>
                      ...
                      <div className="relative w-6 h-px bg-slate-100">
                        <div className="absolute inset-0 bg-blue-500 shadow-[0_0_12px_#3b82f6] animate-pulse-line-1" />
                        <ArrowRight className="absolute -right-1.5 -top-2 w-4 h-4 text-slate-200" />
                      </div>

                      {/* Stage 2: Identity */}
                      <div className="flex flex-col items-center gap-2 flex-1">
                        <div className="w-full h-12 rounded-lg border border-slate-100 bg-slate-50 flex items-center justify-center text-[11px] font-bold text-slate-500 transition-all duration-300 animate-active-node-2 relative overflow-hidden">
                          <div className="absolute inset-0 bg-blue-400/40 blur-xl opacity-0 animate-shining-light-2" />
                          Identity
                        </div>
                      </div>
                      ...
                      {/* Arrow 2 */}
                      <div className="relative w-6 h-px bg-slate-100">
                        <div className="absolute inset-0 bg-blue-500 shadow-[0_0_12px_#3b82f6] animate-pulse-line-2" />
                        <ArrowRight className="absolute -right-1.5 -top-2 w-4 h-4 text-slate-200" />
                      </div>

                      {/* Stage 3: CRM Revenue */}
                      <div className="flex flex-col items-center gap-2 flex-1">
                        <div className="w-full h-12 rounded-lg border border-slate-100 bg-slate-50 flex items-center justify-center text-[11px] font-bold text-slate-500 transition-all duration-300 animate-active-node-3 relative overflow-hidden">
                          <div className="absolute inset-0 bg-blue-400/40 blur-xl opacity-0 animate-shining-light-3" />
                          CRM Revenue
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex justify-center relative">
                      <div className="px-6 py-3 rounded-full border border-slate-100 bg-slate-50 flex items-center gap-2 text-[10px] font-bold text-slate-400 transition-all duration-300 uppercase tracking-wider animate-active-node-4 relative overflow-hidden">
                        <div className="absolute inset-0 bg-blue-400/40 blur-xl opacity-0 animate-shining-light-4" />
      ...
      <style>{`
        @keyframes active-node {
          ...
          50% { background-color: #FA8C16; border-color: #FA8C16; color: #ffffff; box-shadow: 0 4px 20px rgba(250, 140, 22, 0.3); }
        }
        ...
        .animate-active-node-1 { animation: active-node 4s infinite; animation-delay: 0s; }
        .animate-active-node-2 { animation: active-node 4s infinite; animation-delay: 1s; }
        .animate-active-node-3 { animation: active-node 4s infinite; animation-delay: 2s; }
        .animate-active-node-4 { animation: active-node 4s infinite; animation-delay: 3s; }
        
        .animate-shining-light-1 { animation: shining-light 4s infinite; animation-delay: 0s; }
        .animate-shining-light-2 { animation: shining-light 4s infinite; animation-delay: 1s; }
        .animate-shining-light-3 { animation: shining-light 4s infinite; animation-delay: 2s; }
        .animate-shining-light-4 { animation: shining-light 4s infinite; animation-delay: 3s; }
        ...
        .animate-pulse-bg { animation: pulse-bg 4s infinite ease-in-out; }
      `}</style>
    </>
  );
};
