  ...
  return (
    <div className="min-h-screen bg-white font-sans antialiased text-gray-900">
      ...
      <main className="overflow-x-hidden">
        ...
        <section className="py-24 bg-[#CFDBE3]">
          <div className="max-w-[1216px] mx-auto px-6 md:px-12 xl:px-0">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              
              {/* Left Side (Text) */}
              <div className="lg:col-span-4 space-y-6">
                <h2 className="text-5xl md:text-[64px] font-black text-gray-900 leading-[1.05] tracking-tight">
                  Don't just<br />take our<br />word for it
                </h2>
                <div className="pt-4">
                  <span className="inline-flex items-center text-lg font-bold text-gray-900 border-b-2 border-gray-900 pb-1 hover:text-blue-600 hover:border-blue-600 cursor-pointer transition-colors group">
                    Read the full story
              ...
              <div className="lg:col-span-8">
                <div className="flex flex-col sm:flex-row bg-[#F6F5F2] rounded-3xl overflow-hidden shadow-xl">
                  
                  {/* Card Image Area */}
                  <div className="relative w-full sm:w-[45%] bg-[#A8B2BB] min-h-[350px] overflow-hidden">
                    {/* The Green Shape Silhouette Overlay */}
                    <div className="absolute top-0 -right-[30%] w-[130%] h-[120%] bg-[#819277] rounded-full" />
                    
                    {/* The Photo */}
                    <img 
                      src="https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&q=80&w=800" 
                      alt="Customer" 
                      className="absolute bottom-0 left-0 w-full h-[110%] object-cover object-top"
                    />
                  </div>
                  ...
                  <div className="w-full sm:w-[55%] p-8 md:p-10 flex flex-col justify-center">
                    ...
                    <div className="flex items-center gap-3 mb-6">
                       <span className="text-[#0A66C2] font-semibold text-lg flex items-center tracking-tight">
                         Linked<Linkedin className="w-4 h-4 ml-0.5 fill-current" />
                       </span>
                       ...
                       <span className="font-bold text-gray-800 text-lg tracking-tight">DemandSense</span>
                    </div>

                    <p className="text-gray-700 leading-relaxed font-medium mb-8">
                      "DemandSense surfaced valuable insight to validate our strategy. The attribution reporting has helped us to have better discussions around ROI and has made it easier to get budget approved from management."
                    </p>

                    <div>
                      <h4 className="font-bold text-gray-900 text-lg">Niek Dekker</h4>
                      <p className="text-gray-500 text-sm mt-0.5">Head of Marketing<br/>Eftsure</p>
                    </div>
                  </div>
