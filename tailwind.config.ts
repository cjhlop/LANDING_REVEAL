  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Showcase colors
        'showcase': {
          'bg': 'hsl(var(--showcase-bg))',
          'border': 'hsl(var(--showcase-border))',
          'text-primary': 'hsl(var(--showcase-text-primary))',
          'text-secondary': 'hsl(var(--showcase-text-secondary))',
          'link': 'hsl(var(--showcase-link))',
          'link-hover': 'hsl(var(--showcase-link-hover))',
          'separator': 'hsl(var(--showcase-separator))',
          'hover': 'hsl(var(--showcase-hover))',
          'tag-bg': 'hsl(var(--showcase-tag-bg))',
          'icon': 'hsl(var(--showcase-icon))',
          'avatar': 'hsl(var(--showcase-avatar))',
          'score-bg': 'hsl(var(--showcase-score-bg))',
          'score-fill': 'hsl(var(--showcase-score-fill))',
          'positive': 'hsl(var(--showcase-positive))',
          'negative': 'hsl(var(--showcase-negative))',
          'chart-organic': 'hsl(var(--showcase-chart-organic))',
          'chart-paid': 'hsl(var(--showcase-chart-paid))',
        },
      },
      borderRadius: {
        lg: "var(--radius)",
